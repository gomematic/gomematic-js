 ...
 * @module gomematic/model/GeneralError
...
class GeneralError {
  /**
     ...
     * @alias module:gomematic/model/GeneralError
     * @param status {Number}
  ...
  /**
     ...
     * @param {module:gomematic/model/GeneralError} obj Optional instance to populate.
     * @return {module:gomematic/model/GeneralError} The populated <code>GeneralError</code> instance.
     */
