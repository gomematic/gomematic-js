 ...
 * @module gomematic/model/ValidationError
...
class ValidationError {
  /**
     ...
     * @alias module:gomematic/model/ValidationError
     * @param status {Number}
  ...
  /**
     ...
     * @param {module:gomematic/model/ValidationError} obj Optional instance to populate.
     * @return {module:gomematic/model/ValidationError} The populated <code>ValidationError</code> instance.
     */
...
/**
 * @member {Array.<module:gomematic/model/ValidationErrorErrors>} errors
 */
