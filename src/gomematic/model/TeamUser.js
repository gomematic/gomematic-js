 ...
 * @module gomematic/model/TeamUser
 * @version 1.0.0-alpha1
 */
class TeamUser {
  /**
     * Constructs a new <code>TeamUser</code>.
     * @alias module:gomematic/model/TeamUser
     * @param teamId {String}
     * @param userId {String}
     * @param perm {module:gomematic/model/TeamUser.PermEnum}
     */
  ...
  /**
     ...
     * @param {module:gomematic/model/TeamUser} obj Optional instance to populate.
     * @return {module:gomematic/model/TeamUser} The populated <code>TeamUser</code> instance.
     */
