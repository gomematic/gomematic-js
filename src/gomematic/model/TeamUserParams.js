 ...
 * @module gomematic/model/TeamUserParams
 * @version 1.0.0-alpha1
 */
class TeamUserParams {
  /**
     * Constructs a new <code>TeamUserParams</code>.
     * @alias module:gomematic/model/TeamUserParams
     * @param user {String}
     * @param perm {module:gomematic/model/TeamUserParams.PermEnum}
     */
  ...
  /**
     ...
     * @param {module:gomematic/model/TeamUserParams} obj Optional instance to populate.
     * @return {module:gomematic/model/TeamUserParams} The populated <code>TeamUserParams</code> instance.
     */
...
/**
 * @member {module:gomematic/model/TeamUserParams.PermEnum} perm
 */
