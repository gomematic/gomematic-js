 ...
 * @module gomematic/model/InlineObject
 * @version 1.0.0-alpha1
 */
class InlineObject {
  /**
     * Constructs a new <code>InlineObject</code>.
     * @alias module:gomematic/model/InlineObject
  ...
  /**
     ...
     * @param {module:gomematic/model/InlineObject} obj Optional instance to populate.
     * @return {module:gomematic/model/InlineObject} The populated <code>InlineObject</code> instance.
     */
