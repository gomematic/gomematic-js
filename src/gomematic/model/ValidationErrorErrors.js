 ...
 * @module gomematic/model/ValidationErrorErrors
 * @version 1.0.0-alpha1
 */
class ValidationErrorErrors {
  /**
     * Constructs a new <code>ValidationErrorErrors</code>.
     * @alias module:gomematic/model/ValidationErrorErrors
     */
  constructor () {
  ...
  /**
     ...
     * @param {module:gomematic/model/ValidationErrorErrors} obj Optional instance to populate.
     * @return {module:gomematic/model/ValidationErrorErrors} The populated <code>ValidationErrorErrors</code> instance.
     */
