 ...
 * @module gomematic/model/AuthLogin
 * @version 1.0.0-alpha1
 */
class AuthLogin {
  /**
     * Constructs a new <code>AuthLogin</code>.
     * @alias module:gomematic/model/AuthLogin
  ...
  /**
     ...
     * @param {module:gomematic/model/AuthLogin} obj Optional instance to populate.
     * @return {module:gomematic/model/AuthLogin} The populated <code>AuthLogin</code> instance.
     */
